...
{{-- 
		<div class="d-flex justify-content-center">
        	<h1 style="color:#428bca">Iniciar sesión</h1>
    	</div> --}}
		{{-- <hr> --}}
		<div class="">
    		<div class="">
				<form id="demoForm" method="post" action="{{ url('administrador/menu')  }}" data-toggle="validator" role="form">
					{{ csrf_field() }}
                    <div class="box">
                        <div id="header">
                          <div id="cont-lock"><i class="material-icons lock"><i class="fas fa-lock"></i></i></div>
                          <div id="bottom-head"><h1 id="logintoregister">Iniciar sesión</h1></div>
                        </div> 
                         <form action="" method="post">
                          <div class="group">      
                            <input class="inputMaterial" type="text" id="usuario" name="usuario" required>
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>Usuario</label>
                          </div>
                              <div class="group">      
                            <input class="inputMaterial" type="password" id="contrasena" name="contrasena" required>
                            <span class="highlight"></span>
                            <span class="bar"></span>
