                    ...
                    <form name='formconfirma' method='post' action=''>                    
                        <div id="datosDiaSeleccionado" class="col-md-12">
                            ...
                            <div id="espacio-datos" class="col-md-12" style="padding: 10px; margin-top: -20px; background: #D8D8D8; border-radius: 15px;">
                                ...
                                <div class='col-md-2'>
                                    <div class="filadatos">
                                        <span class="campos"><label for="tipo_documento">Tipo Documento</label></span> <span class="datos" id="s_tipo_doc"></span><input type="hidden" name="f_tipo_doc" id="f_tipo_doc" >xxx
                                    </div>
                                </div>
                                <div class='col-md-3'>
                                    <div class="filadatos">
                                        <span class="campos"><label for="numero_documento">Número de Documento</label></span> <span class="datos" id="s_nro_doc"></span><input type="hidden" name="f_nro_doc" id="f_nro_doc">xxx
                                    </div>
                                </div>
                                <div class='col-md-2'>
                                    <div class="filadatos">
                                        <span class="campos"><label for="primer_apellido">Apellido</label></span> <span class="datos" id="s_apellido"></span><input type="hidden" name="f_apellido" id="f_apellido">xxx
                                    </div>
                                </div>
                                <div class='col-md-2'>
                                    <div class="filadatos">
                                        <span class="campos"><label for="primer_nombre">Nombre</label></span> <span class="datos" id="s_nombre"></span><input type="hidden" name="f_nombre" id="f_nombre">xxx
                                    </div>
                                </div>
                                <div class='col-md-2'>
                                    <div class="filadatos">
                                        <span class="campos"><label for="s_telefono">Telefono</label></span> <span class="datos" id="s_telefono"></span><input type="hidden" name="f_telefono" id="f_telefono">xxx
                                    </div>
                                </div>
                                <div class='col-md-2'>
                                    <div class="filadatos">
                                        <span class="campos"><label for="email">eMail</label></span> <span class="datos" id="s_email"></span><input type="hidden" name="f_email" id="f_email">xxx
                                    </div>
                                </div>
                                <!--</div>-->
                                <!--cierra columna1-->
                        ...
                        <div class="col-md-12"  >
                            ...
                            <div id="btn_confirmar2" class="col-md-3" >
                                <button type="button" id="bt_grabar" class="btn btn-success" style="margin-top: 25px; margin-left: 30px" onclick="save_all();">Confirmar</button>
...
<script>
    function selectTramite(){
        ...
        if (idTramiteSeleccionado != 0) {
            ...
            //alert($("#requisitos_tramite").height());
    ...
    function carga_datosPersonales(){
        ...
        if ($("[name='form']").length == 0) {
            ...
            var url ="{{ URL::to('/nuevoTurno/formdatospersonales') }}";
